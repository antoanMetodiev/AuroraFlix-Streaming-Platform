...
import { parseMovieIdFromSlug, tmdbImage } from "@/lib/tmdb";
...
export async function generateMetadata({
  ...
  const backdrop = tmdbImage(movie.backgroundImg_URL, "w1280");

  return {
    title: movie.title,
    description: movie.description ?? `Watch ${movie.title} on AuroraFlix.`,
    openGraph: {
      title: movie.title,
...
export default async function MovieDetailsPage({
  ...
  return <CinemaRecordDetailsPage record={movie} type="movie" />;
}
